...
public class ProductDAO {
	...
	public List<ProductListUserVO> selectProductTopListUser() throws SQLException{
		...
		try {
			...
			String selectQuery="select prod_num, prod_name, prod_price, prod_image from product where prod_cat=? and prod_delete=?"
	...
	public List<ProductListUserVO> selectProductBottomListUser() throws SQLException{
		...
		try {
			...
			String selectQuery="select prod_num, prod_name, prod_price, prod_image from product where prod_cat=? and prod_delete=? order by prod_num desc";
			pstmt = con.prepareStatement(selectQuery);
	...
	public ProductDetailUserVO selectProductUser(int num) throws SQLException{
		...
		try {
			...
			if(rs.next()) {
				pduVO=new ProductDetailUserVO(rs.getString("prod_num"), rs.getString("prod_name"),
							rs.getString("prod_price"),rs.getString("prod_explain"),rs.getString("prod_image"));
