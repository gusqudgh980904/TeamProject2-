...
<link rel="stylesheet" href="http://localhost/team_prj2/common/css/slider.css" rel="stylesheet">
    ...
    <!-- container start -->
        ...
        <!-- slider start -->
		    ...
		    <ul id="imgholder" class="imgs">
		        <li><img src="http://localhost/team_prj2/common/images/2.jpg"></li>
		        <li><img src="http://localhost/team_prj2/common/images/3.jpg"></li>
		        <li><img src="http://localhost/team_prj2/common/images/4.jpg"></li>
		        <li><img src="http://localhost/team_prj2/common/images/5.jpg"></li>
		    </ul>
		    <div class="bullets">
