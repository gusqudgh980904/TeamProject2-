...
<div id="wrap">
	...
	<h1 id="headerTitle">SANGHAUI STREET ADMINISTRATOR</h1>
		<h1 id="title" >상품추가</h1>
				<form  enctype="multipart/form-data" id="prod_addFrm" name="prod_addFrm" method="post" action="http://localhost/team_prj2/prj2/admin/admin_details/process/product_add_process.jsp">
