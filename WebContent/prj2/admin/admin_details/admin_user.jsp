...
function remove(){
	window.open("http://localhost/team_prj2/prj2/admin/popup/user_delete.jsp","remove","width=650,height=380px")
}//confirm
</script>
</head>
<body>
<!-- header start -->
    <header class="header">
        <div class="main_nav">
            <div>
                <h1 class="title"><a href="#"><img src="http://localhost/jsp_prj/common/images/%EC%83%81%ED%95%98%EC%9D%98%EC%8A%A4%ED%8A%B8%EB%A6%BF.png"></a></h1>
                <ul class="navigation">
